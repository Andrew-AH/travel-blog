...
export default function PackingChecklist() {
  ...
  return (
    <section className="packing-section" id="packing-list" aria-labelledby="packing-heading">
      <div className="packing-intro">
        <span className="packing-script">Less luggage. More freedom.</span>
        <h2 id="packing-heading">Pack a little lighter.</h2>
        <p>A small bag makes room for a big adventure. Start with the essentials, then add a few things for your kind of getaway.</p>
