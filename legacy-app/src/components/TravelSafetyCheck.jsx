...
export default function TravelSafetyCheck() {
    ...
    <section className="travel-safety" id="country-safety" aria-labelledby={`${fieldId}-title`}>
      <div className="travel-safety-main">
        <div className="travel-safety-intro">
          ...
          <h2 id={`${fieldId}-title`}>Country safety check</h2>
          <p>Before the flights and the daydreams, check the advice for where you’re going.</p>
