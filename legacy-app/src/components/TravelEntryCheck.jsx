...
export default function TravelEntryCheck() {
  const fieldId = useId()
  ...
  return (
    <section className="travel-entry" id="entry-requirements" aria-labelledby={`${fieldId}-title`}>
      <div className="travel-entry-heading">
        ...
        <h2 id={`${fieldId}-title`}>Visas &amp; entry fees</h2>
        <p>Some trips need a visa, travel authorisation, arrival form or visitor levy. Check what applies to your passport, route and travel dates before you fly.</p>
      </div>
